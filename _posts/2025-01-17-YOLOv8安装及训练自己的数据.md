...
从网上下载了烟草相关的数据及论文，想自己复现论文。[论文地址](https://www.mdpi.com/2073-4395/13/12/2861/xml)
 ...
 <font size=3 color=green>20205年9月的时候看到GPT说如果只是在Python中使用CUDA，可以直接在Anaconda中装</font>  
 [Pytorch官方的命令行](https://pytorch.org/get-started/previous-versions/)    
...
if __name__ == "__main__":
 ...
 <font size=4 color=Red>以下是我2025年1月的方法</font>   
